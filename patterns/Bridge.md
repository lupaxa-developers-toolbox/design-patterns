...
from its implementation, allowing the two to vary independently. This pattern
involves an abstraction and an implementation class, with a bridge interface
connecting them. By separating the abstraction from its implementation, the
bridge pattern promotes flexibility and extensibility, enabling different
implementations to be swapped or extended without affecting the abstraction.

...
placeholder for another object to control access to it. This pattern is used to
add an extra level of indirection to support controlled access, lazy
initialization, logging, and other similar tasks. By implementing the same
interface as the underlying object, the proxy can act as a stand-in, forwarding
requests to the real object while adding its behaviour. This approach enhances
control over the underlying object, promoting flexibility and maintainability in
software design.

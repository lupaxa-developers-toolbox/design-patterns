...
cloning an existing object, known as the prototype. This pattern is useful when
the cost of creating an object from scratch is more expensive than copying an
existing instance. By using prototypes, the system can create new objects
efficiently and dynamically, promoting flexibility and reducing the need for
subclassing.
